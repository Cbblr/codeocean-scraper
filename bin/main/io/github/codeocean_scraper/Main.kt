...
private fun printUsage() {
    println("Usage: codeocean_scraper exerciseUrl targetDirectory deadline filetype")
    System.exit(1)
}
...
fun main(args: Array<String>) {
    ...
    val (exerciseUrlStr, targetDirectory, rawDeadline, fileSuffix) = args
    ...
    for ((name, url) in studentSubmissionPages.sortedBy { it.first }) {
        ...
        analyseAndSave(url, fetcher, name, deadline, Paths.get(targetDirectory), mapper, fileSuffix)
    }
}
